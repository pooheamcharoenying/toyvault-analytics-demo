...
export async function GET(req) {
  try {
    ...
    const targetUrl = new URL("/api/all_planograms", API_BASE_URL);
    if (searchParams.get("brand")) targetUrl.searchParams.set("brand", searchParams.get("brand"));
    if (searchParams.get("all_brands")) targetUrl.searchParams.set("all_brands", searchParams.get("all_brands"));
