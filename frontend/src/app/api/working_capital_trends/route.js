...
export async function GET(req) {
  try {
    ...
    const targetUrl = new URL("/api/working_capital_trends", API_BASE_URL);
    if (searchParams.get("window_months")) targetUrl.searchParams.set("window_months", searchParams.get("window_months"));
