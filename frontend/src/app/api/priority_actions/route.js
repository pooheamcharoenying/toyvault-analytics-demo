...
export async function GET(req) {
  try {
    ...
    const maxActions = searchParams.get("max_actions") || "30";

    const targetUrl = new URL("/api/priority_actions", API_BASE_URL);
    targetUrl.searchParams.set("max_actions", maxActions);
