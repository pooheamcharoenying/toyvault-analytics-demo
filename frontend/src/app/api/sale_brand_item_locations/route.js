// src/app/api/sale_brand_item_locations/route.js
...
export async function GET(req) {
  try {
    ...
    const output = searchParams.get("output") || "item";
    const brandName = searchParams.get("brand_name") || "";

    // 🧭 build target URL and pass the same query param through
    const targetUrl = new URL("/api/sale_brand_item_locations", API_BASE_URL);
    targetUrl.searchParams.set("output", output);
    targetUrl.searchParams.set("brand_name", brandName);
