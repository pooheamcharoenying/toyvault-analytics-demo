...
export async function GET(req) {
  try {
    ...
    const targetUrl = new URL("/api/brand_monthly_trend", API_BASE_URL);
    if (searchParams.get("brand_name")) targetUrl.searchParams.set("brand_name", searchParams.get("brand_name"));
