...
export async function GET(req) {
  try {
    ...
    const targetUrl = new URL("/api/seasonality_analysis", API_BASE_URL);
    if (searchParams.get("dimension")) targetUrl.searchParams.set("dimension", searchParams.get("dimension"));
    if (searchParams.get("filter_value")) targetUrl.searchParams.set("filter_value", searchParams.get("filter_value"));
